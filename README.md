...
![](https://skillicons.dev/icons?i=java,js,ts,php,py,c,cpp,html,css,sass&theme=dark)

![](https://skillicons.dev/icons?i=nodejs,react,nextjs,tailwind,redis&theme=dark)

### 🛠️ Tools I love use

![](https://skillicons.dev/icons?i=vscode,idea,git,github,gitlab,docker,linux,jenkins,bash,powershell,mysql,mongodb,maven,gradle,cloudflare,postman,stackoverflow&theme=dark)
